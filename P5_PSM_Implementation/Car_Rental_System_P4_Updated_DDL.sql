...
CREATE MASTER KEY ENCRYPTION BY PASSWORD = 'CarRentalSystemMasterKey@DAMG6210';


-- Step 1: Create a Certificate
CREATE CERTIFICATE CarRentalSystem  
   WITH SUBJECT = 'Car Rental System';  
GO  

-- Step 2: Create a Symmetric Key Encrypted by the Certificate
CREATE SYMMETRIC KEY CarRentalSystemColumnKey  
    WITH ALGORITHM = AES_256  
    ENCRYPTION BY CERTIFICATE CarRentalSystem;  
GO  
...
(
    ...
    DateOfBirth VARBINARY(MAX)  NOT NULL,
    Gender CHAR(1) CHECK (Gender IN ('M', 'F', 'O')),
    PhoneNumber VARBINARY(MAX),
