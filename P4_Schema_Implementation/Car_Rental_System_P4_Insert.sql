...
('EMP', 'John', 'Doe', '1985-07-12', 'M', '555-1111', 'john.doe@carrental.com', 'American', 1),
('CUS', 'Jane', 'Smith', '1990-11-25', 'F', '555-2222', 'jane.smith@gmail.com', 'American', 2),
('EMP', 'Mike', 'Brown', '1975-03-15', 'M', '555-3333', 'mike.brown@carrental.com', 'Canadian', 3),
('CUS', 'Emily', 'Davis', '1992-06-30', 'F', '555-4444', 'emily.davis@yahoo.com', 'British', 4),
('EMP', 'Sarah', 'Johnson', '1988-09-22', 'F', '555-5555', 'sarah.johnson@carrental.com', 'Australian', 5),
('CUS', 'Chris', 'Lee', '1995-12-01', 'M', '555-6666', 'chris.lee@hotmail.com', 'American', 6),
('EMP', 'Anna', 'White', '1982-02-18', 'F', '555-7777', 'anna.white@carrental.com', 'Canadian', 7),
('CUS', 'David', 'Martinez', '1989-05-10', 'M', '555-8888', 'david.martinez@gmail.com', 'Mexican', 8),
('EMP', 'Mark', 'Wilson', '1980-10-20', 'M', '555-9999', 'mark.wilson@carrental.com', 'American', 9),
('CUS', 'Sophia', 'Taylor', '1993-08-15', 'F', '555-0000', 'sophia.taylor@outlook.com', 'American', 10);

-- Insert data into Employee
INSERT INTO Employee (Employee_PersonID, JobTitle, Department, HireDate, Salary, EmployeeStatus, WorkShift, BranchID) VALUES
(1, 'Manager', 'Sales', '2015-05-01', 60000, 'Active', 'Morning', 1),
(3, 'Sales Associate', 'Sales', '2016-07-15', 40000, 'Active', 'Afternoon', 2),
(5, 'Technician', 'Maintenance', '2017-03-20', 45000, 'On Leave', 'Night', 3),
(7, 'Receptionist', 'Front Desk', '2018-11-05', 35000, 'Active', 'Morning', 4),
(9, 'Supervisor', 'Sales', '2019-08-10', 50000, 'Inactive', 'Afternoon', 5);
...
(4, '2024-11-25', '2022-01-01', '2022-12-31', 'Debit Card', 'E2345678'),
